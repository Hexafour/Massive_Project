              ...
              <div className="frame-16">
                <div className="frame-17">
                  ...
                  <div className="frame-19">
                    <div className="text-wrapper-9">Smart Watch</div>
                  </div>
                </div>
                <div className="frame-17">
                  <div className="frame-18">
                    <div className="overlap-group-2">
                      <div className="heart-wrapper">
                        <IconComponentNode className="heart-instance" />
                      </div>
                    </div>
                  </div>
                  <div className="frame-19">
                    <div className="text-wrapper-10">Air Purifier</div>
                  </div>
                </div>
                <div className="frame-17">
                  <div className="frame-18">
                  ...
                  <div className="frame-19">
                    <div className="text-wrapper-10">Treadmill</div>
                  </div>
                </div>
                <div className="frame-17">
                  <div className="frame-18">
                  ...
                  <div className="frame-19">
                    <div className="text-wrapper-9">Gluco Meter</div>
                  </div>
                </div>
                <div className="frame-17">
                  <div className="frame-18">
                  ...
                  <div className="frame-19">
                    <div className="text-wrapper-10">Electric Toothbrush</div>
                  </div>
                </div>
                <div className="frame-17">
                  <div className="frame-18">
                  ...
                  <div className="frame-19">
                    <div className="text-wrapper-10">Earphone</div>
                  </div>
                </div>
              </div>
            </div>
