                ...
                <div className="frame-11">
                  <div className="frame-17">
                    ...
                    <div className="frame-19">
                      <div className="text-wrapper-9">Headband</div>
                    </div>
                  </div>
                  <div className="frame-17">
                    <div className="frame-18">
                    ...
                    <div className="frame-19">
                      <div className="text-wrapper-10">WaistBag</div>
                    </div>
                  </div>
                </div>
                <div className="frame-11">
                  <div className="frame-17">
                    ...
                    <div className="frame-19">
                      <div className="text-wrapper-9">Mask</div>
                    </div>
                  </div>
                  <div className="frame-17">
                    <div className="frame-18">
                    ...
                    <div className="frame-19">
                      <div className="text-wrapper-10">Gloves</div>
                    </div>
                  </div>
                </div>
                <div className="frame-11">
                  <div className="frame-17">
                    ...
                    <div className="frame-19">
                      <div className="text-wrapper-9">Hat</div>
                    </div>
                  </div>
                  <div className="frame-17">
                    <div className="frame-18">
                    ...
                    <div className="frame-19">
                      <div className="text-wrapper-10">Glasses</div>
                    </div>
                  </div>
                </div>
              </div>
